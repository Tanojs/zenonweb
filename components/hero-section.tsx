...
const SLIDES = [
  {
    ...
    title: <>HOSTING <span className="bg-gradient-to-r from-[#6C3CE1] to-[#a855f7] bg-clip-text text-transparent">PREMIUM</span></>,
  ...
  },
  {
    ...
    title: <>SC <span className="bg-gradient-to-r from-[#6C3CE1] to-[#a855f7] bg-clip-text text-transparent">BOT</span></>,
  ...
  {
    category: "APP",
    title: <>APP <span className="bg-gradient-to-r from-[#6C3CE1] to-[#a855f7] bg-clip-text text-transparent">PREMIUM</span></>,
                ...
                <div className="flex-[0_0_100%] min-w-0 relative h-[260px] sm:h-[350px] flex items-center p-6 sm:p-12" key={index}>
                  ...
                  <div className="relative z-10 w-full">
                    ...
                    <div className={`transition-all duration-700 delay-1000 ${selectedIndex === index ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                      <Link 
                        href={slide.target} 
                        className="inline-flex items-center gap-1.5 bg-gradient-to-r from-[#6C3CE1] to-[#a855f7] text-white px-4 py-2 rounded-lg font-black text-[10px] uppercase transition-all shadow-lg active:scale-95 shadow-[#6C3CE1]/25"
                      >
